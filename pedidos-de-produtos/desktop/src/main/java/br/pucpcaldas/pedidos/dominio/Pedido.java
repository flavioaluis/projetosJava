...
/**Um objeto da classe <code> ItemDoPedido</code> representa as informações de um
 * pedido efetuado pelo cliente. Um pedido é composto de objetos da clase <code>ItemDoPedido</code>.
 * 
 * @author flavio
 * version 1.0
 * @see ItemDoPedido
...
public class Pedido {
    ...
    /**
     * Calcula total do pedido que é igual oma do custo total
